  ...
  return (
    <section className="bg-white w-full p-0 shadow overflow-hidden">
      ...
      <div className="flex px-6 py-4 justify-between items-center">
        ...
        <Link
          to="/products"
          className="inline-block bg-primaryBlue text-white text-sm sm:text-base font-medium px-4 py-2 sm:px-6 sm:py-2.5 rounded-md shadow-md hover:bg-blue-700 hover:text-white transition duration-300 ease-in-out"
        >
          VIEW ALL
        </Link>
      </div>
