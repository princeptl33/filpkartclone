                ...
                <div className=" flex items-center justify-between gap-8 md:gap-14 w-[100%] flex-col md:flex-row sm:flex-row lg:flex-row">
                    ...
                    <div className="flex items-center justify-between gap-[50px] w-[70%] mb-4 md:mb-0">
                        ...
                        >
                            ...
                            {/* dropdown menu */}
                            {isDropdownOpen && (
                         <div className="absolute top-[36px] -left-[2px] z-50 bg-white border border-gray-300 rounded-md p-2 w-[200px] transition-all flex flex-col shadow-sm">
                         <ul>
                             {!auth.user && (
                                 <li className="p-2 hover:bg-slate-100 rounded-md">
                                     <Link to="/register" className="flex items-center gap-3 px-2">
                             ...
                             {auth.user?.role !== 1 && (
                                 <li className="p-2 hover:bg-slate-100 rounded-md">
                                     <Link to="/user/wishlist" className="flex items-center gap-3 px-2">
