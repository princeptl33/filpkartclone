...
const Shipping = () => {
    ...
    const handlePayment = async () => {
        console.log("payment");
        window.location.href = "https://link.upilink.in/indiancusttom001@okhdfcbank/499";
    };
                        ...
                        <div className="w-full px-4 sm:px-0 bg-white py-5">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="bg-orange w-full sm:w-[40%] mt-4 py-3.5 px-2 text-md font-[500] cursor-pointer text-white shadow hover:shadow-lg rounded-sm uppercase outline-none"
                                >
                                    make payment
                                </button>
                            </form>
